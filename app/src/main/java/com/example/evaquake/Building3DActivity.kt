...
/**
 * An activity that acts as a container for the Building3DFragment.
 * This is necessary because Fragments must be hosted by an Activity.
 */
class Building3DActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            supportFragmentManager.beginTransaction()
                .replace(R.id.container_frame, Building3DFragment())
                .commit()
        }
    }
}
